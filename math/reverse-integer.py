...
assert sol.reverse(2147483647) == 0, "Test case 7 failed"
assert sol.reverse(-2147483648) == 0, "Test case 8 failed"
assert sol.reverse(2147483412) == 2143847412, "Test case 9 failed"
assert sol.reverse(-2147483412) == -2143847412, "Test case 10 failed"
...
assert sol.reverse_2(2147483647) == 0, "Test case 7 failed"
assert sol.reverse_2(-2147483648) == 0, "Test case 8 failed"
assert sol.reverse_2(2147483412) == 2143847412, "Test case 9 failed"
assert sol.reverse_2(-2147483412) == -2143847412, "Test case 10 failed"
